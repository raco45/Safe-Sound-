...
import { PROFILE_PAGE_EDIT, DOCTOR_EDIT } from "../../constants/url";
    ...
    <div className="md:flex">
      ...
      <div className="p-10 w-2/4">
        ...
        <div className="mt-20 ml-16">
          <button className="md:w-auto w-32 px-4 py-2 text-white transition-colors duration-200 transform bg-[#3E0576] rounded-md hover:bg-purple-600 focus:outline-none focus:bg-purple-600 mt-6">
            <Link to={user.role === "Paciente"?PROFILE_PAGE_EDIT:DOCTOR_EDIT}> Editar perfil</Link></button> 
        </div>
      </div>
    </div>
  );
